...
var addOverviewTestData = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                completedOrderA = {
                    status: order_1.OrderStatus.open, // will set to completed at the end
                    userId: 0, // set later
                };
                completedOrderB = {
                    status: order_1.OrderStatus.open, // will set to completed at the end
            ...
            case 23:
                _a.sent();
                // set order status to completed
                completedOrderA.status = order_1.OrderStatus.completed;
                completedOrderB.status = order_1.OrderStatus.completed;
                return [4 /*yield*/, orderStore.edit(completedOrderA)];
            case 24:
                _a.sent();
                return [4 /*yield*/, orderStore.edit(completedOrderB)];
            case 25:
                _a.sent();
                return [3 /*break*/, 27];
            case 26:
...
exports.default = addOverviewTestData;
